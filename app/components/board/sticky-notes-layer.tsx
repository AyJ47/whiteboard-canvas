  ...
  <>
    {notes.map((note) => {
      ...
      return (
        <div
          key={note.id}
          className={`pointer-events-auto absolute flex flex-col overflow-hidden rounded-lg border border-zinc-300 shadow-[0_8px_18px_rgba(15,23,42,0.16)] ${
        ...
        >
          <div
            className="flex h-8 cursor-move touch-none items-center justify-between gap-2 border-b border-black/10 px-2"
          ...
          >
            ...
            <button
              ...
              className="flex h-6 w-6 items-center justify-center rounded-md border border-black/10 text-zinc-700 transition-colors hover:bg-black/10 hover:text-zinc-950"
          ...
          <textarea
            ...
            className="min-h-0 flex-1 resize-none bg-transparent p-3 text-zinc-900 outline-none placeholder:text-zinc-600/70"
          ...
          {selected && (
            <>
              <div className="flex h-9 items-center justify-between gap-2 border-t border-black/10 px-2">
                ...
                <div className="flex shrink-0 items-center gap-1">
                  <button
                    ...
                    className="h-6 min-w-7 rounded-md border border-black/10 px-1 text-xs font-semibold text-zinc-700 transition-colors hover:bg-black/10 disabled:cursor-not-allowed disabled:opacity-40"
                  ...
                  <button
                    ...
                    className="h-6 min-w-7 rounded-md border border-black/10 px-1 text-sm font-semibold text-zinc-700 transition-colors hover:bg-black/10 disabled:cursor-not-allowed disabled:opacity-40"
              ...
              <div
                ...
                className="absolute -bottom-1.5 -right-1.5 h-4 w-4 cursor-nwse-resize touch-none rounded-full border border-blue-500 bg-white shadow-sm"
                role="button"
